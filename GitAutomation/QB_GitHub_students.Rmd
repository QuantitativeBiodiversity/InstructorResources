...
In 2017, student repos from previous years were downloaded to local computers and then deleted. 
...
(Jay forked InstructorResources to local machine then copied the contents of the GitAutomation folder to a new directory -- QBstudents -- that he created)
...
QB2019_Test
```
Note you will also have QB2019_Test, which is for instructors use as it cannot be accessed by students.
